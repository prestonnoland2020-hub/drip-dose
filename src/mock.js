...
const T = {
  ...
  coffees: [
    ...
    { id: C2, slug: 'onyx|geometry', roaster: 'Onyx Coffee Lab', name: 'Geometry', origin: 'Ethiopia / Colombia', process: 'Natural / Washed', roast_level: 'light', blend: true, decaf: false, tasting_notes: 'blueberry, jasmine, black tea', field_sources: { origin: 'user' }, created_at: ago(300), updated_at: ago(3) },
  ],
  brews: [
