...
const SEL = 'id, user_id, coffee_id, method, dose_g, water_g, ratio, temp_c, grind_label, grind_setting, grinder, brewer, recipe, actual, total_seconds, rating, acidity, sweetness, body, clarity, balance, notes, feedback, ai_recipe, ai_reason, modifications, next_time, photo_path, public, created_at, coffees(id, roaster, name, origin, process, roast_level, blend, image_path, image_url)'
const shape = b => b ? { ...b, photo_url: imageUrl(b.photo_path), coffees: b.coffees ? { ...b.coffees, image_url: pic(b.coffees) } : null } : b
